...
api_key = 'AIzaSyBiapz0gSqWX-A1L8ZuMeEi9fOEjW2BY18'  
...
with st.sidebar:
    selected = option_menu(None, ["Extract & Transform","View"], 
                           icons=["tools","card-text"],
                           default_index=0,
...
def channel_details(channel_id):
    ...
    com_details = get_comments_details(v_ids)

    coll1 = db["channel_details"]
    coll1.insert_one({"channel_information":ch_details,"channel_videos":vi_ids,"video_information":vi_details,
...
if selected == "View":
    ...
    st.write("Please Select Your Question")
    ...
    if questions == '1. What are the names of all the videos and their corresponding channels?':
    ...
    elif questions == '3. What are the top 10 most viewed videos':
        ...
        st.bar_chart(df.set_index('Video_name')['views'])
        fig = px.bar(df,
    ...
    elif questions == '4. How many comments were made on each video':
